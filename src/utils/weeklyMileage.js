...
export const MILEAGE_SPORTS = ['running', 'swim', 'bike', 'other']

function emptyTotals() {
  return { running: 0, swim: 0, bike: 0, other: 0 }
}
...
// swim/bike/other only — lifting/note have no distance concept). Pure "did
// they actually cover the distance" total.
