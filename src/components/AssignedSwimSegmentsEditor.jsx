...
export const emptyAssignedSwimSegment = () => ({
...
// Same pattern as AssignedSegmentsEditor (running) — one target time per
// segment (applies to each rep), not per individual rep.
export default function AssignedSwimSegmentsEditor({ segments, onChange }) {
  ...
  function addSegment() {
    onChange([...segments, emptyAssignedSwimSegment()])
  }
