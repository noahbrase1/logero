...
// meters, a sled push in feet) — kept as its own concrete component rather
// than a shared/parameterized editor, consistent with how this codebase
// already keeps per-type segment editors separate (Swim/Bike/etc).
